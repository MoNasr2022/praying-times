...
You can improve the readability and maintainability of your code by using an array of objects with IDs. Here's a better way to format the data:
...
const availableCities = [
  ...
  const getTimings = async () => {
    const res = await axios.get(
      `http://api.aladhan.com/v1/timingsByCity?city=${selectedCity}&country=USA&timestamp=${date}`
    );
    console.log(res);
